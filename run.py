...
def main():
    ...
    frames_path = images_path+'/houses/'
    results_path = images_path+'/graded_images/'
    ...
    for i, file in enumerate(files):
        ...
        digit_set_loader = DataLoader(digit_dataset, batch_size=64, num_workers=0, shuffle=False)
        ...
        cv2.imwrite(os.path.join(results_path, f'{i+1}.png'), vis4)
